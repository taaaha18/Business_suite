    ...
    <div className="sidebar-container">
      ...
      <div className="sidebar-nav">
        <SidebarNavButton
          ...
          onClick={() =>
            handleButtonClick('dashboard', `/Developer_Dash?email=${encodeURIComponent(email || "")}`)
          }
        ...
        <SidebarNavButton
          ...
          onClick={() =>
            handleButtonClick('clients', `/Developer_Profile?email=${encodeURIComponent(email || "")}`)
          }
        ...
        <SidebarNavButton
          ...
          onClick={() => handleButtonClick('projects', `/Developer_Interview?email=${encodeURIComponent(email || "")}`)}
        ...
        <SidebarNavButton
          ...
          onClick={() => handleButtonClick('time-tracking', `/Developer_time?email=${encodeURIComponent(email || "")}`)}
        ...
        <SidebarNavButton
          ...
          onClick={() => handleButtonClick('invoices', `/Developer_Stats?email=${encodeURIComponent(email || "")}`)}
        ...
        <SidebarNavButton
          ...
          onClick={() => handleButtonClick('settings', `/settings?email=${encodeURIComponent(email || "")}`)}
